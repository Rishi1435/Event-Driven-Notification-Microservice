...
const app = require('../server'); // Adjusted path from ../../src/api/server
const QueueClient = require('../../shared/utils/queueClient'); // Adjusted path from ../../src/shared/utils/queueClient

// Mock QueueClient
// Mock QueueClient Factory to avoid loading the file (which requires amqplib from shared path)
jest.mock('../../shared/utils/queueClient', () => {
    return class QueueClient {
